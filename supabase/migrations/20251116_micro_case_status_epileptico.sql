...
BEGIN
  ...
  INSERT INTO public.micro_case_options (node_id,label,next_node_id,feedback_md,score_delta,is_critical,target_roles) VALUES
    ...
    (v_refractario_pre_intub_node,'PENTOBARBITAL 5-15 mg/kg + fentanilo 1 mcg/kg + rocuronio 1 mg/kg (si disponible)',v_intubacion_node,'Pentobarbital es alternativa internacional si midazolam falla o no disponible. Requiere monitoreo invasivo, riesgo de hipotensión y depresión miocárdica. No disponible en todos los centros.',2,false,ARRAY['medico']),
  ...
  INSERT INTO public.micro_case_options (node_id,label,next_node_id,feedback_md,score_delta,is_critical,target_roles) VALUES
    ...
    (v_midazolam_inf_node,'PENTOBARBITAL 0.5-5 mg/kg/h infusión continua, titular a burst-suppression en EEG (si disponible)',v_eeg_continuo_node,'Pentobarbital es alternativa internacional si midazolam falla o no disponible. Requiere monitoreo invasivo, riesgo de hipotensión y depresión miocárdica. No disponible en todos los centros.',2,false,ARRAY['medico']),
