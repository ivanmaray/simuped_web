...
BEGIN
  ...
  INSERT INTO public.micro_case_nodes (case_id, kind, body_md, order_index, is_terminal, metadata) VALUES (
    v_case_id,
    'decision',
    'T+10 min. Midazolam intranasal 0.2 mg/kg administrado a T+0. A T+5 min sin respuesta: lorazepam IV 0.1 mg/kg (2.4 mg) administrado (acceso IV obtenido). Ahora T+10 min total: persiste actividad convulsiva generalizada. FC 148, TA 102/64, SatO2 94% con O2 mascarilla 10L, secreciones moderadas. Glucemia 76 mg/dL. Según protocolo SECIP: tras 2 benzodiacepinas sin respuesta en 10 min → iniciar SEGUNDA LÍNEA. Opciones: fenitoína/fosfenitoína 20 mg PE/kg, valproato 40 mg/kg, o levetiracetam 60 mg/kg. ¿Qué fármaco de segunda línea seleccionas considerando perfil del paciente (epiléptico conocido en LEV crónico, sin cardiopatía)?',
    1,
    false,
  ...
  -----------------------------------------------------------------
  INSERT INTO public.micro_case_options (node_id,label,next_node_id,feedback_md,score_delta,is_critical,target_roles) VALUES
    (v_midazolam_inf_node,'MIDAZOLAM iniciar 0.1 mg/kg/h, titular cada 5-10 min hasta objetivo EEG (burst-suppression) máx 0.4 mg/kg/h',v_eeg_continuo_node,'Opción estándar SECIP: midazolam es primera línea en status superrefractario, titulación guiada por EEG (burst-suppression es objetivo), perfil seguro. Inicio conservador permite valorar respuesta antes de escalar.',4,true,ARRAY[''medico'']),
    (v_midazolam_inf_node,'TIOPENTAL 3-5 mg/kg/h infusión continua, titular a burst-suppression en EEG',v_eeg_continuo_node,'Opción SECIP válida: tiopental muy efectivo (gold standard histórico), pero requiere monitoreo hemodinámico invasivo (hipotensión frecuente), vasopresores casi siempre. Con PAM 65 es arriesgado como primera opción.',2,false,ARRAY[''medico'']),
